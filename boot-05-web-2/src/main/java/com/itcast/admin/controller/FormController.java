...
public class FormController {
	...
	public String upload(@RequestParam("email") String email, @RequestParam("username") String username,
			@RequestPart("headerImg") MultipartFile headerImg, @RequestPart("photos") MultipartFile[] photos)
			throws IOException {

		log.info("上傳信息: email={}. username={}. headerImg={}. photos={}", email, username, headerImg.getSize(),
				photos.length);
